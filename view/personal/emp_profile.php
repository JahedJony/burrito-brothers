				...
				<div class="row">
					<div class="col-md-9">	
						...
						<div class="form-group">
							...
							<div class="col-md-4 col-sm-4 col-xs-6">
								<input type="text" id="dept_name" name="dept_name" required class="form-control col-lg-12" readonly="readonly"/>
							</div>	
						</div>					
						<div class="form-group">
	...
	load_emp_profile = function load_emp_profile(){
		...
		$.ajax({
			...
			success: function(data){
				...
				$('#desg_name').val(data.records.designation_title);
				$('#dept_name').val(data.records.department_name);

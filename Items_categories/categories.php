<div class="main-part">
    ...
    <!-- End Dishes Part -->
    <!-- Start Discount Part -->
    <section class="discount-part wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="discount-left">
                        <h6 class="heade-xs">HAPPY CUSTOMER EVENT</h6>
                        <h2>DISCOUNT <span>50%</span></h2>

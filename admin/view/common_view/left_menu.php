		...
		<ul class="nav side-menu">
            ...
            <li><a><i class="fa fa-users"></i>Items<span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu" style="display: none">
                    ...
                    <li><a href="index.php?module=items&view=hotItems">Hot Items</a></li>
		   ...
		   <li><a><i class="fa fa-users"></i>Order<span class="fa fa-chevron-down"></span></a>
			...
			<li><a><i class="fa fa-bell"></i>Notifications<span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu" style="display: none">
                    <li><a href="index.php?module=notification&view=notification">All Notifications</a></li>
                    <li><a href="index.php?module=notification&view=adminNotification">Admin Notifications</a></li>
                    <li><a href="index.php?module=notification&view=notificationSend">Notification Send</a></li>
                </ul>
            </li>
			
			<li><a><i class="fa fa-envelope"></i>Template<span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu" style="display: none">
...
<!----------------------all module will be settings and view name will corresponding view-->
			...
			<!--<li><a><i class="fa  fa fa-bar-chart-o"></i>REPORTS <span class="fa fa-chevron-down"></span></a>
				<ul class="nav child_menu" style="display: none">
					<li><a href="index.php?module=reports&view=group_permission">Reports</a></li>
				</ul>
			</li> -->

        ...
        <table id="ingredient_Table" name="table_records" class="table table-bordered  responsive-utilities jambo_table table-striped  table-scroll ">
            <thead >
                <tr class="headings">
                    ...
                    <th class="column-title" width="">Ingredient Name</th>
                    <th class="column-title" width="15%">Unit Size</th>
                    <th class="column-title" width="15%">Unit Price</th>
		...
		<form method="POST"  id="ingredient_form" name="ingredient_form" enctype="multipart/form-data" class="form-horizontal form-label-left">   
			<div class="row">
				<div class="col-md-9">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4 col-xs-6">Size<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <input type="text" id="ingredient_size_name" name="ingredient_size_name" class="form-control col-lg-12"/>
                            <input type="hidden" id="ingredient_size_id" name="ingredient_size_id" />
                        </div>
                    </div>
                    <div class="form-group">
				...
				<div class="col-md-3">
					<img src="<?php echo $website_url ?>images/no_image.png" width="70%" height="70%" class="img-thumbnail" id="ingredient_img">
		...
		$.ajax({
			...
			success: function(data) {
				...
				if(!jQuery.isEmptyObject(records_array)){
					...
					var colums_array=["photo*image*"+project_url,"id*identifier*hidden","ingredient_name","size_name","ingredient_price","code"];
